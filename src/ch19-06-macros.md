...
<span class="caption">Llistat 19-28: A simplified version of the `vec!` macro
definition</span>
...
<span class="caption">Llistat 19-29: An example of defining a procedural
macro</span>
...
<span class="caption">Llistat 19-30: The code a user of our crate will be able
...
<span class="caption">Llistat 19-31: Code that most procedural macro crates
...
<span class="caption">Llistat 19-32: The `DeriveInput` instance we get when
...
<span class="caption">Llistat 19-33: Implementing the `HelloMacro` trait using
