...
<span class="caption">Llistat 17-3: Definition of the `Draw` trait</span>
...
<span class="caption">Llistat 17-4: Definition of the `Screen` struct with a
...
<span class="caption">Llistat 17-5: A `run` method on `Screen` that calls the
...
<span class="caption">Llistat 17-6: An alternate implementation of the `Screen`
...
<span class="caption">Llistat 17-7: A `Button` struct that implements the
`Draw` trait</span>
...
<span class="caption">Llistat 17-8: Another crate using `gui` and implementing
...
<span class="caption">Llistat 17-9: Using trait objects to store values of
...
<span class="caption">Llistat 17-10: Attempting to use a type that doesn’t
