...
<span class="caption">Llistat 15-25: A cons list definition that holds a
...
<span class="caption">Llistat 15-26: Creating a reference cycle of two `List`
...
<span class="caption">Llistat 15-27: Creating a `leaf` node with no children
...
<span class="caption">Llistat 15-28: A `leaf` node with a weak reference to its
...
<span class="caption">Llistat 15-29: Creating `branch` in an inner scope and
