...
<span class="caption">Llistat 18-8: Attempting to use a refutable pattern with
`let`</span>
...
<span class="caption">Llistat 18-9: Using `if let` and a block with refutable
...
<span class="caption">Llistat 18-10: Attempting to use an irrefutable pattern
with `if let`</span>
