...
<span class="caption">Llistat 15-17: Demonstrating we’re not allowed to have
...
<span class="caption">Llistat 15-18: A definition of `List` that uses
`Rc<T>`</span>
...
<span class="caption">Llistat 15-19: Printing the reference count</span>
