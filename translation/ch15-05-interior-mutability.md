...
<span class="caption">Llistat 15-20: A library to keep track of how close a
...
<span class="caption">Llistat 15-21: An attempt to implement a `MockMessenger`
...
<span class="caption">Llistat 15-22: Using `RefCell<T>` to mutate an inner
...
<span class="caption">Llistat 15-23: Creating two mutable references in the
...
<span class="caption">Llistat 15-24: Using `Rc<RefCell<i32>>` to create a
